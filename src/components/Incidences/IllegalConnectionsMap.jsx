...
import TablePagination from "../incidences/TablePagination";
import Barchart from "../Util/bar";
import MyPie from "../Util/pie";
import Linechart from "../Util/lineChart";
import MapPieChart from "../Incidences/MapPieChart";
import { useLayoutEffect } from "react";
import Analysis from "../incidences/Analysis";
...
export default function Home(props) {
  ...
  useEffect(() => {
    fetch(`/api/reports/type/Illegal Connection/${offset}`)
      .then((res) => {
        if (!res.ok) {
          throw Error("Could not fetch data!!!");
        } else {
  ...
  return (
    <div className="bdy-wrapper">
      ...
      <div className="bdy-container">
        <Navigation active="Illegal Connections" />
